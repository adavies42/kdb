...
.finos.unzip.priv.pfd:{
  ...
  if[r`xln;
    r:update{x[;`id]!x}.finos.unzip.priv.parse[(.finos.unzip.priv.pxfd;.finos.unzip.priv.wxfd);xfd;count xfd]from r;
  ...
  r:$[
    ...
    `unzip=x;
      [
        ...
        / parse file data
        / TODO rewrite this to use central directory?
        fd:.finos.unzip.priv.parse[(.finos.unzip.priv.pfd;.finos.unzip.priv.wfd;z);y;(ecd`cof)-exec min lof from cd];
